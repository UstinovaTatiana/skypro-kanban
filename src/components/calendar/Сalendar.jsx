    ...
    <CalendarBlock className="pop-new-card__calendar calendar">
      <CalendarNav className="calendar__nav">
        ...
        <NavActions className="nav__actions">
          <NavAction data-action="prev" className="nav__action">
            <svg
              width="6"
              height="11"
              viewBox="0 0 6 11"
          ...
          <NavAction data-action="next" className="nav__action">
            <svg
              width="6"
              height="11"
              viewBox="0 0 6 11"
      ...
      <CalendarContent className="calendar__content">
        <DaysNames className="calendar__days-names">
          <DayName className="calendar__day-name">пн</DayName>
          <DayName className="calendar__day-name">вт</DayName>
          <DayName className="calendar__day-name">ср</DayName>
          <DayName className="calendar__day-name">чт</DayName>
          <DayName className="calendar__day-name">пт</DayName>
          <DayName className="calendar__day-name -weekend-">сб</DayName>
          <DayName className="calendar__day-name -weekend-">вс</DayName>
        </DaysNames>

        <Cells className="calendar__cells">
          <CalendarCell className="calendar__cell _other-month" otherMonth>
            28
          </CalendarCell>
          <CalendarCell className="calendar__cell _other-month" otherMonth>
            29
          ...
          <CalendarCell className="calendar__cell _cell-day" current>
            31
          </CalendarCell>
          <CalendarCell className="calendar__cell _cell-day">1</CalendarCell>
          <CalendarCell className="calendar__cell _cell-day _weekend">
            2
          </CalendarCell>
          <CalendarCell className="calendar__cell _cell-day _weekend">
            3
          ...
          <CalendarCell className="calendar__cell _cell-day _current">
            8
          </CalendarCell>
          <CalendarCell className="calendar__cell _cell-day _weekend">
            9
          ...
          <CalendarCell className="calendar__cell _other-month _weekend">
            1
          </CalendarCell>
        </Cells>
      </CalendarContent>

      <HiddenInput id="datepick_value" value="08.09.2023" />
      <CalendarPeriod className="calendar__period">
        <CalendarPeriodText className="calendar__p date-end">
